...
var catalogExtraApps = []catalogItem{
	...
	panelApp("milvus", "Milvus", "人工智能", "开源向量数据库，RAG Embeddings 存储", 19530, "Coin"),
	panelApp("qdrant", "Qdrant", "人工智能", "向量搜索引擎，语义检索", 6333, "Search"),
	panelApp("weaviate", "Weaviate", "人工智能", "GraphQL 向量库，混合检索", 8080, "Coin"),
	panelApp("victoria-metrics", "VictoriaMetrics", "BI", "高性能时序指标与集群遥测", 8428, "TrendCharts"),
	panelApp("ceph", "Ceph RGW", "云存储", "Ceph 对象网关与分布式存储元数据", 7480, "FolderOpened"),
	panelApp("vllm", "vLLM", "人工智能", "高性能 GPU 推理引擎（OpenAI 兼容 API）", 8000, "Odometer"),
	...
	panelApp("posthog", "PostHog", "BI", "产品分析、会话回放、Feature Flags、A/B、问卷与错误追踪（建议 8GB+ RAM）", 8020, "DataAnalysis"),
