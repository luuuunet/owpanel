...
func (s *Service) Templates(lang string) []Template {
	...
	return []Template{
		...
		{ID: "certbot", Name: t(lang, "certbot"), Desc: t(lang, "certbotDesc"), Schedule: "0 2 * * *", Command: "certbot renew --quiet 2>/dev/null && (systemctl reload openresty 2>/dev/null || systemctl reload nginx 2>/dev/null || true)", Icon: "SSL", Color: "#f59e0b"},
